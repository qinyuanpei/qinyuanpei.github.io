...
description: 对具体观察者而言，我们需要做的就是继承Observer类然后重写Update方法，在这里我们需要实现两个不同的类EmailObserver和WechatObserver，它们分别来实现邮件和公众号接收到主题推送消息以后的逻辑，这里以EmailObserver为例，代码实现如下：
tags:
- Redis
- 缓存
- 设计模式
...
![设计者模式的UML类图](https://ws1.sinaimg.cn/large/None.jpg)
...
![观察者模式基本实例](https://ws1.sinaimg.cn/large/None.jpg)
...
![Redis中的消息模式](https://ws1.sinaimg.cn/large/None.jpg)
